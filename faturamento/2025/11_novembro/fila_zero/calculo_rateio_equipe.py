...
ARQUIVO_PDF_RATEIO_RECEITA = os.path.join(PASTA_SCRIPT, 'R_RECEITA_PROCEDIMENTO_FILAZERO_1125.pdf')
ARQUIVO_PDF_PRODUCAO_CONTA = os.path.join(PASTA_SCRIPT, 'R_PRODUCAO_MEDICA_CONTA_FILAZERO_1125.pdf')
...
def gerar_html(df_rateio, df_ind_res, df_ind_det, total_bolo):
    ...
    <head>
        <meta charset='UTF-8'>
        <title>Relatório de Repasse Médico - FILA ZERO- {comp_label}</title>
