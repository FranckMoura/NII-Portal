# ==============================================================================
# SISTEMA DE REPASSES - FILA ZERO TERCEIROS (V1.0 - BASEADO NA V2.6 SADT)
# Autor: Franck Moura (Via NII Automation)
# Data: 26/12/2025
# Descrição: Processa receita SADT/Terceiros específica do FILA ZERO.
#            Mantém as mesmas regras de agrupamento e visual do relatório mensal.
# ==============================================================================
...
print(f"--- Processando Fila Zero - Terceiros/SADT ---")

# Busca automática (Procura PDFs de lançamentos/receita na pasta do script)
...
# ==============================================================================
# 2. MAPA DE GRUPOS SUS (MESMAS REGRAS DO MENSAL)
# ==============================================================================
def definir_grupo_macro(codigo, descricao):
    ...
    # Backup Hemodiálise (sem pegar clínico)
...
# ==============================================================================
# 4. GERAÇÃO DO HTML (VISUAL 3 CARDS)
# ==============================================================================
        ...
        <div class='header-bg p-8 shadow-lg mb-8'>
            <div class='max-w-7xl mx-auto'>
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class='text-3xl font-bold'>Fila Zero - Terceiros/SADT</h1>
...
if __name__ == "__main__":
    if ARQUIVO_ENTRADA:
        ...
        if not df_dados.empty:
            ...
            reg = {
                "titulo": f"Fila Zero Terceiros - {comp_label}",
